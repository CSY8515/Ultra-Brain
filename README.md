...
current release is **v0.94 User Custom UI & Canvas Editor**, which completes the
registry-driven theme package, detail adjustment, preset, preview, and User Custom Canvas layer.
...
[release notes](RELEASE_NOTES_v0.7.md). v0.94's UI remains an Ultra Brain-owned
