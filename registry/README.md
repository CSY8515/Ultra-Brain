...
extended through the approved v0.2 Safety release. Registries index governed
...
- `decision_registry.json`: accepted Foundation and v0.2 Safety decisions;
- `release_registry.json`: immutable v0.1 Foundation and v0.2 Safety records;
- `interface_registry.json` and `contract_registry.json`: approved v0.2 Safety
  publication indexes.
