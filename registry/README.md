...
extended through the approved v0.5 Collaboration & Connectivity release. Registries index governed
...
- `decision_registry.json`: accepted Foundation and v0.2-v0.5 decisions;
- `release_registry.json`: immutable v0.1 through v0.5 release records;
- `interface_registry.json` and `contract_registry.json`: approved Safety,
  Enhancement, Automation, and Collaboration & Connectivity publication indexes.
