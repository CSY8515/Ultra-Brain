...
class ArtifactTests(unittest.TestCase):
    def test_json_and_registry(self):
        ...
        self.assertEqual((interface["version"],contract["version"],registry["version"]),("0.6.0","0.6.0","0.6.0")); self.assertEqual(registry["interface"],interface["id"]); self.assertEqual(registry["contract"],contract["id"])
