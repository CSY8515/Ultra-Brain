"""Validate Foundation, cumulative integrations, and the v0.95 UI release.
...
UI_LEGACY_VERSION = "0.9.0"
UI_PREVIOUS_VERSION = "0.91.0"
UI_THEME_VERSION = "0.92.0"
...
def validate_registries(errors: list[str]) -> None:
    ...
    if release_registry:
        ...
        if set(releases) != {
            ...
            "ultra-brain-v0-92-official-theme-system",
            "ultra-brain-v0-93-layout-custom-ui",
            "ultra-brain-v0-94-user-custom-ui-canvas-editor",
            "ultra-brain-v0-95-advanced-theme-visual-world-engine",
        }:
            errors.append("release_registry.json must contain exactly v0.1 through v0.95 milestones")
        elif (
            ...
            or releases["ultra-brain-v0-9-official-ui-ux-final"].get("current_version") != UI_LEGACY_VERSION
            or releases["ultra-brain-v0-9-official-ui-ux-final"].get("status") != "released"
            or releases["ultra-brain-v0-91-hierarchy-propagation-final"].get("current_version") != UI_PREVIOUS_VERSION
            or releases["ultra-brain-v0-91-hierarchy-propagation-final"].get("status") != "released"
            or releases["ultra-brain-v0-92-official-theme-system"].get("current_version") != UI_THEME_VERSION
            or releases["ultra-brain-v0-92-official-theme-system"].get("status") != "released"
            or releases["ultra-brain-v0-93-layout-custom-ui"].get("current_version") != UI_POLISH_VERSION
            or releases["ultra-brain-v0-93-layout-custom-ui"].get("status") != "released"
            or releases["ultra-brain-v0-94-user-custom-ui-canvas-editor"].get("current_version") != UI_CUSTOM_VERSION
            or releases["ultra-brain-v0-94-user-custom-ui-canvas-editor"].get("status") != "released"
            or releases["ultra-brain-v0-95-advanced-theme-visual-world-engine"].get("current_version") != UI_VERSION
...
def main() -> int:
    ...
    if errors:
        print("Ultra Brain v0.95 release validation: FAILED")
        for error in errors:
            print(f"- {error}")
        return 1

    print("Ultra Brain v0.95 release validation: PASSED")
