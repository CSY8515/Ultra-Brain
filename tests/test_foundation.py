...
class FoundationTests(unittest.TestCase):
    ...
    def test_version_is_current_v0_984(self) -> None:
        self.assertEqual((ROOT / "VERSION").read_text(encoding="utf-8").strip(), "0.984")
    ...
    def test_personal_secretary_registry_is_active_at_v0_61(self) -> None:
        registry = json.loads((ROOT / "registry" / "meta_os_registry.json").read_text(encoding="utf-8"))
        ...
        self.assertEqual(secretary["current_version"], "0.61.0")
        self.assertIn("personal-secretary-operational-reporting-interface", secretary["interface"])
        self.assertIn("personal-secretary-operational-reporting-contract", secretary["contract"])
